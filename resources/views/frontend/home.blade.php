    ...
    @if ($leaders->isNotEmpty())
            ...
            <section class="relative bg-gray-50 py-16 lg:py-20">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="pointer-events-none absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-gray-50 to-transparent">
                        </div>
                        <div
                            class="pointer-events-none absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-gray-50 to-transparent">
                        </div>
                                        ...
                                        <div class="text-center group">
                                            <a href="{{ route('lecturers.show', $lecturer->nidn) }}" class="block">
                                                <div class="relative w-36 h-36 md:w-40 md:h-40 mx-auto">
                                                    <img src="{{ $lecturer->photo ? Storage::url($lecturer->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($lecturer->name) . '&size=160' }}"
                                                        alt="{{ $lecturer->name }}"
                                                ...
                                                <h3
                                                    class="mt-4 text-base md:text-lg font-extrabold text-gray-800 group-hover:text-red-800 transition-colors">
                                                    {{ $lecturer->name }}
                                                </h3>
        ...
        @push('styles')
            ...
            <style>
                ...
                .lecturers-swiper .swiper-wrapper {
                    transition-timing-function: linear;
                }

                /* Lebar slide biar proporsional */
                .lecturers-swiper .swiper-slide {
                    width: auto;
                }
            </style>
        @endpush
        ...
        <section class="py-16 lg:py-20">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    ...
                    <p class="mt-2 text-lg text-slate-800">Pengalaman mereka yang telah menjadi mahasiswa Universitas
                        Muhammadiyah Sumatera Barat.</p>
                </div>
